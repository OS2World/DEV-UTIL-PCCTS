 ...
 * fset2.c
 *
 * $Id: fset2.c,v 1.8 1993/08/24 14:44:32 pccts Exp pccts $
 * $Revision: 1.8 $
 *
 ...
 *
 * Added by TJP 9-23-92 to correct the LL(k) constraint mechanism to work.
 */
Tree *
#ifdef __STDC__
prune( Tree *t, int k )
...
/* is lookahead sequence t a member of any context tree for any predicate in p? */
static int
#ifdef __STDC__
